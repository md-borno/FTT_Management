...
<div class="row mb-4">
    <div class="col">
        <h2><i class="bi bi-pencil"></i> Edit Service Plan</h2>
        <p class="text-muted">Update service plan information</p>
    </div>
    <div class="col-auto">
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('service-plans.update', $servicePlan) }}">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('slug') is-invalid @enderror" 
                           id="slug" name="slug" value="{{ old('slug', $servicePlan->slug) }}" required>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('bandwidth') is-invalid @enderror" 
                           id="bandwidth" name="bandwidth" value="{{ old('bandwidth', $servicePlan->bandwidth) }}" 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" 
                               id="price" name="price" value="{{ old('price', $servicePlan->price) }}" required>
                    </div>
                    @error('price')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                           id="sort_order" name="sort_order" value="{{ old('sort_order', $servicePlan->sort_order) }}" min="0">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" 
                              id="description" name="description" rows="2">{{ old('description', $servicePlan->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                    ...
                    <div class="border rounded p-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="features[]" value="internet" 
                                   {{ in_array('internet', old('features', $features)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="features[]" value="static_ip"
                                   {{ in_array('static_ip', old('features', $features)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="features[]" value="priority_support"
                                   {{ in_array('priority_support', old('features', $features)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="features[]" value="unlimited_data"
                                   {{ in_array('unlimited_data', old('features', $features)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="features[]" value="free_installation"
                                   {{ in_array('free_installation', old('features', $features)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="features[]" value="wifi_router"
                                   {{ in_array('wifi_router', old('features', $features)) ? 'checked' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="is_active" 
                               name="is_active" value="1" {{ old('is_active', $servicePlan->is_active) ? 'checked' : '' }}>
